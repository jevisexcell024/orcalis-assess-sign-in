...
import {
  ...
  Globe, Search, Download, CheckSquare, Square, X, Filter,
  BookOpen, Clock, CheckCircle2, FolderArchive, BarChart2, Layers,
} from "lucide-react";
...
function ExamsPage() {
  ...
  // Render child routes (wizard, builder) directly without list chrome
        ...
        <div className="rounded-2xl border border-border bg-background shadow-sm overflow-hidden">
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center gap-3 py-20">
              ...
              <Button size="sm" className="gap-1.5 text-white mt-1" style={{ background: NAVY }} onClick={() => navigate({ to: "/admin/exams/new" })}>
                    ...
                    >
                      <td className="px-4 py-3">
                        <button onClick={() => toggleOne(exam.id)} className="text-muted-foreground hover:text-foreground">
                          {isSelected ? <CheckSquare className="h-4 w-4 text-[oklch(0.385_0.12_247)]" /> : <Square className="h-4 w-4" />}
                        </button>
                      </td>
                      <td className="px-4 py-3">
                        <div>
                      ...
                      <td className="px-4 py-3">
                        <div className="relative">
                          <button
                            onClick={() => setOpenMenu(isMenuOpen ? null : exam.id)}
